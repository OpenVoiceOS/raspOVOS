...
/home/$OVOS_USER/.venvs/ovos/bin/ovos-config autoconfigure --lang de-DE --online --male --platform rpi3
...
LANG_CODE=de bash /mounted-github-repo/scripts/write_build_manifest.sh lite
