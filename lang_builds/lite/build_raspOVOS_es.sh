...
/home/$OVOS_USER/.venvs/ovos/bin/ovos-config autoconfigure --lang es-ES --online --male --platform rpi3
...
LANG_CODE=es bash /mounted-github-repo/scripts/write_build_manifest.sh lite
