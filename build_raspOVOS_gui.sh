...
add_user_to_group $OVOS_USER video
# Adding user to render group
add_user_to_group $OVOS_USER render
...
chmod 644 /home/$OVOS_USER/.config/systemd/user/ovos-shell.service
# Enable services manually by creating symbolic links
mkdir -p /home/$OVOS_USER/.config/systemd/user/default.target.wants/
ln -s /home/$OVOS_USER/.config/systemd/user/ovos-shell.service /home/$OVOS_USER/.config/systemd/user/default.target.wants/ovos-shell.service
