...
def main(argv) -> int:
    ...
    if verify != 0:
        ...
        print("A copy reported as outside the venv is installed in the system "
              "python, which this venv reads through --system-site-packages. "
              "Only the system install can replace it.")
        return 1
    return pip_check()
